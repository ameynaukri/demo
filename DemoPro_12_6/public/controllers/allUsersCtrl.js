...
*/
    ...
    $scope.selectedItemChanged = function(isValid){
        //alert("iiiiiiiiiiiiiiiiiiii"+$scope.formData.Country);
        $http.get($rootScope.serviceURL+"getAllRecords?id="+$scope.formData.Country).then(function(response) {
        $scope.Country_name = response.data.result;
